        ...
        <nav class="navbar navbar-default navbar-fixed-top before-color">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <img src="images/lui.png" href="index.html" style="height: 70px;"></img>
                </div>
            ...
            <div class="tp-banner">
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500">
                        <!-- MAIN IMAGE -->
                        <img src="images/steel5.jpg" alt="desk" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption slider-title" data-x="center" data-y="center"  data-voffset="-30" data-speed="500" data-start="1200" data-easing="Power4.easeInOut" style="font-weight: bold;">
                            COMPANY PROFILE
                        </div> <!-- /tp-caption -->
                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption slider-caption" data-x="center" data-y="center" data-voffset="40" data-speed="500" data-start="1800" data-easing="Power4.easeInOut" data-captionhidden="on" style="color: #0404B4; font-weight: bold;">
                            LINTAS UTAMA INTERNASIONAL
                        </div> <!-- /tp-caption -->
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500">
                        <!-- MAIN IMAGE -->
                        <img src="images/steel7.jpg" alt="desk" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text-center">
                        <div class="section-title">
                            <h1><span class="alo">LINTAS UTAMA INTERNASIONAL</span></h1> 
                            <span class="border-line"></span>
                            <p class="lead subtitle-caption">
                                we are a broker company of the most important
                                international manufacturing companies. located in <span class="colored-text">Riau Island, Indonesia</span>
                            </p>
                        </div>
                    </div>
                </div><!-- title row end-->
                    ...
                    <div class="col-sm-6 margin-bottom30">
                        <div class="feature-icon-wrap clearfix">
                            ...
                            <div class="features-text-right">
                                ...
                                <p>
                                    We are a broker company of the most important
international manufacturing companies. We
deliver Electrical Parts.
                                </p>
                            </div>
...
deliver Containers.
                ...
                <div class="row">
                    <div class="col-sm-6 margin-bottom30">
                        <div class="feature-icon-wrap clearfix">
                            <div class="left-side-icon">
                                <i class="ion-aperture front-icon"></i>
                                <i class="ion-aperture back-icon"></i>
                            </div>
                            <div class="features-text-right">
                                <h3>Helicopter Shelter and Hangars</h3>                         
                                <p>
                                    We are a broker company of the most important
international manufacturing companies. We
deliver Helicopter Shelter and Hangars.
                                </p>
                            </div>
                        </div><!--features icon wrap-->
                    </div><!--features col-->
                    <div class="col-sm-6 margin-bottom30">
                        <div class="feature-icon-wrap clearfix">
                            <div class="left-side-icon">
                                <i class="ion-ios-home-outline front-icon"></i>
                                <i class="ion-ios-home-outline back-icon"></i>
                            </div>
                            <div class="features-text-right">
                                <h3>Furniture and Interior</h3>                         
                                <p>
                                    We are a broker company of the most important
international manufacturing companies. We
deliver Furniture and Interior.
                                </p>
                            </div>
                        </div><!--features icon wrap-->
                    </div><!--features col-->
        ...
        <section id="services" class="section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text-center">
                        <div class="section-title">
                            <h1>Our <span class="colored-text">Clients</span></h1> 
                            <span class="border-line"></span>
                        </div>
                    </div>
                </div><!-- title row end-->
